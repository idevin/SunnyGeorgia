...
class TourBookingCanceled extends Notification
{
    use Queueable;
    ...
    public function toMail(User $notifiable)
    {
        return (new MailMessage)
            ->subject(trans('mail.tour_booking.Tour booking canceled', [], $notifiable->locale))
            ->greeting(trans('mail.Hello!', [], $notifiable->locale))
            ->line(trans('mail.tour_booking.Your tour was canceled', [], $notifiable->locale))
