<template>
    <div class="tour-booking-confirm">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    <form @submit.prevent="onFormSubmit">
                        ...
                        <!--<div class="col-sm-8 position-relative confirm-field-wrapper">-->
                        <!--<input  v-if="formRole === 'control'"-->
                        <!--type="email"-->
                        <!--class="form-control"-->
                        <!--placeholder="Email"-->
                        <!--v-model="vModels.user.email"-->
                        <!--:readonly="booking.customer.email_verified"-->
                        <!--&gt;-->
                        <!--<span v-if="formRole === 'partner'">{{ booking.customer.email ? booking.customer.email : '-&#45;&#45;' }}</span>-->
                        <!--<span class="confirm-field-icon position-absolute">-->
                        <!--<i-->
                        <!--class="fa fa-check-circle-o"-->
                        <!--:class="{ 'm&#45;&#45;font-success': booking.customer.email_verified }"-->
                        <!--&gt;</i>-->
                        ...
                        <!--v-model="vModels.user.mobile_number"-->
                        <!--:readonly="booking.customer.mobile_confirmed"-->
                        <!--&gt;-->
                        <!--<span v-if="formRole === 'partner'">{{ booking.customer.mobile_number ? booking.customer.mobile_number : '-&#45;&#45;' }}</span>-->
                        <!--<span class="confirm-field-icon position-absolute">-->
                        <!--<i-->
                        <!--class="fa fa-check-circle-o"-->
                        <!--:class="{ 'm&#45;&#45;font-success': booking.customer.mobile_confirmed }"-->
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2">Tour</label>
                            <div class="col-sm-10">
                                <p>id: {{ tour.id }} <strong>{{ tour.title }}</strong>
                                    <a :href="tourLink"><i class="fa fa-eye"></i></a>
                                </p>
                                <p>{{ tour.place.name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div v-if="booking.food">{{ booking.food.title }}</div>
                                <div v-if="!booking.food">---</div>
                            </div>
                        </div>


                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Дата начала тура</label>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Желаемое размещения</label>
                            <div class="col-sm-4">
                                <label>Отель</label>
                                <span class="form-control">{{booking.hotel}}</span>
                            </div>
                            <div class="col-sm-4">
                                <label>Вариант размещения</label>
                                <span class="form-control">{{booking.accommodation_variant}}</span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Колличество участников</label>
                            <template v-if="booking.qty_kids">
                                <div class="col-sm-2">
                                    <label>Взрослые</label>
                                    <span class="form-control">{{booking.qty_adults}}</span>
                                </div>
                                <div class="col-sm-2">
                                    <label>Дети</label>
                                    <span class="form-control">{{booking.qty_kids}}</span>
                                </div>
                                <div class="col-sm-4">
                                    <label>Возраст детей</label>
                                    <span class="form-control">{{booking.kids_ages}}</span>
                                </div>
                            </template>
                            <template v-else>
                                <div class="col-sm-4">
    ...
    export default {
            ...
            onFormSubmit() {
                ...
                axios.post(this.formAction, this.booking)
                    .then((response) => {
                        ...
                        if (response.data.tourBooking) {
                            this.booking = response.data.tourBooking;
                        }
        ...
        created() {
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                // self.user_partner = window.tour.user;
                // self.partner = window.tour.partner;
                // self.tour = window.tour;
                // self.place = window.tour.place;
