            ...
            <div class="filter-section__items">
              <div class="filter-section-item">
                <label class="checkbox-row">
                  <div class="checkbox checkbox-primary">
                    <input type="radio" :value="null" class="checkbox-field" v-model="selectedKind"
                           @change="emitChanges1()"/>
                    <span class="checkbox-label"></span>
                  </div>
              ...
              <div class="filter-section-item">
                <label class="checkbox-row">
                  <div class="checkbox checkbox-primary">
                    <input type="radio" value="group" class="checkbox-field" v-model="selectedKind"
                           @change="emitChanges1()"/>
                    <span class="checkbox-label"></span>
                  </div>
              ...
              <div class="filter-section-item">
                <label class="checkbox-row">
                  <div class="checkbox checkbox-primary">
                    <input type="radio" value="person" class="checkbox-field" v-model="selectedKind"
                           @change="emitChanges1()"/>
                    <span class="checkbox-label"></span>
                  </div>
          ...
          <div class="filter-section">
            ...
            <div class="filter-section__items">
              <div class="filter-section-item" v-for="type in serverData.types" :key="type.id">
                <label class="checkbox-row">
                  <div class="checkbox checkbox-primary">
                    <input type="checkbox" :value="type.id" class="checkbox-field"
                           v-model="selectedTypes" @change="emitChanges1()"/>
                    <span class="checkbox-label"></span>
                  </div>
...
export default {
  props: ['currencyCode', 'total', 'param1', 'param2'],
  ...
  methods: {
      ...
      ApiFilter.getExcursionsParams(stringify({filter: {...query}}))
          .then(({data}) => {
            if (data.count) {
              ...
              this.$refs.sliderMobile.setValue([data.priceMin, data.priceMax]);
            } else {
    ...
    mapPropsToData() {
      if (this.param1) {
        ...
        if (this.param1.kind) {
          this.selectedKind = this.param1.kind;
        }
