    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
                ...
                <div class="m-portlet__head-tools">
                    ...
                    <div class="btn-group btn-group-lg" role="group" aria-label="Button group with nested dropdown">
                        <a href="{{route('cabinet:partner:tours.edit', $tour->id)}}"
                           class="btn btn-default"><i class="fa fa-file-alt"></i></a>
                        ...
                        <a href="{{route('cabinet:partner:tours.calendar', $tour->id)}}"
                           class="btn btn-default active"><i class="fa fa-calendar-alt"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                <form action="{{route('cabinet:partner:tours.accommodation.update_availability_form')}}" method="post">
                    {!! csrf_field() !!}
                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">
                                    ...
                                    @endphp
                                    <a href="{{route('cabinet:partner:tours.calendar', [$tour->id, 'month' => $prevMonth->month, 'year' => $prevMonth->year])}}"
                                    ...
                                    <a href="{{route('cabinet:partner:tours.calendar', [$tour->id, 'month' => $nextMonth->month, 'year' => $nextMonth->year])}}"
                                       class="btn btn-default">
                                     <span>
																<span>
                                ...
                                @for($hotLinksDatePointer; $hotLinksDateTo->diffInMonths($hotLinksDatePointer, true) > 0; $hotLinksDatePointer->addMonth())
                                    <li class="m-portlet__nav-item">
                                        ...
                                        @if($date->diffInMonths($hotLinksDatePointer) !== 0)
                                            <a href="{{route('cabinet:partner:tours.calendar', [$tour->id, 'month' => $hotLinksDatePointer->month, 'year' => $hotLinksDatePointer->year])}}">
    ...
    <div class="modal fade" id="availability_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{route('cabinet:partner:tours.accommodation.update_availability')}}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group m-form__group m--margin-top-10">
                            <div class="alert m-alert m-alert--default" role="alert">
                                Форма изменяет только выбранные даты и дни недели. Дни которые не попадают в период, не изменяются.
                                Чтобы сбросить доступное количество туров на 0, укажите число 0 в доступное количество и выберите период.
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <input class="form-control"
                                       type="number" step="1" min="0" max="99999"
                                       value="100"
                                       name="amount"
